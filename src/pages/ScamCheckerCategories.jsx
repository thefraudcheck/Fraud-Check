    ...
    setMessages([
      ...
      },
      {
        ...
        options: [
          { label: <><TruckIcon className="w-5 h-5" /> Buying a Vehicle</>, value: 'buying-a-vehicle' },
          { label: <><CurrencyDollarIcon className="w-5 h-5" /> Crypto Payment</>, value: 'crypto-payment' },
          { label: <><ArrowsRightLeftIcon className="w-5 h-5" /> Own Account Transfer</>, value: 'own-or-group-transfer' },
          { label: <><ChartBarIcon className="w-5 h-5" /> Investment</>, value: 'investment' },
          { label: <><ShoppingCartIcon className="w-5 h-5" /> Retail Purchase</>, value: 'retail-purchase' },
          { label: <><CreditCardIcon className="w-5 h-5" /> Card Payment</>, value: 'card-payment' },
          { label: <><BuildingLibraryIcon className="w-5 h-5" /> Loan or Grant</>, value: 'loan-or-grant' },
          { label: <><BriefcaseIcon className="w-5 h-5" /> Job or Business</>, value: 'job-or-business' },
          { label: <><HeartIcon className="w-5 h-5" /> Loved One</>, value: 'loved-one' },
          { label: <><WrenchScrewdriverIcon className="w-5 h-5" /> Repair</>, value: 'repair' },
          { label: <><UserGroupIcon className="w-5 h-5" /> Family Request</>, value: 'family-request' },
          { label: <><CalendarIcon className="w-5 h-5" /> Subscription</>, value: 'subscription' },
          { label: <><QrCodeIcon className="w-5 h-5" /> QR Code</>, value: 'qr-code' },
          { label: <><CubeIcon className="w-5 h-5" /> Delivery or Post</>, value: 'delivery-or-post' },
          { label: <><WrenchScrewdriverIcon className="w-5 h-5" /> Construction</>, value: 'construction' },
          { label: <><QuestionMarkCircleIcon className="w-5 h-5" /> Other</>, value: 'other' },
        ],
        timestamp: new Date(),
      },
